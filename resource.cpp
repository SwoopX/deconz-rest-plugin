...
const char *RStatePresenceArea = "state/presencearea";
const char *RStatePresenceAreaEvent = "state/presenceareaevent";
...
const char *RConfigDetectionArea = "config/detectionarea";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStatePresenceArea));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt16, QVariant::Double, RStatePresenceAreaEvent));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RConfigDetectionArea));
